...
2. Manual override UI so you can edit a security's asset class or custom allocations?
3. Persisted allocation cache so it doesn't recompute on every page load?